...
/**
 * Core: storage/settings + filesystem dirs.
 *
 * (Moved from /includes/ to /modules/core/)
 */
final class Storage {
	...
	public function ensure_directories(): void {
		...
		$this->mkdir_p($base . '/db');
		$this->mkdir_p($base . '/db-pro');
	}
	...
	public function get_settings(): array {
		$defaults = [
			...
			'rp_keep_last' => 10,
			'rp_max_blob_bytes' => 20 * 1024 * 1024,
			...
			'rp_include_db' => false,
			'rp_db_engine' => 'basic', // basic|pro
			'rp_db_tables' => 'wp_core',
			'rp_db_custom_tables' => '',
